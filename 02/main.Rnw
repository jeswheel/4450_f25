...
\begin{frame}[allowframebreaks]{The distribution function}
  ...
  \begin{block}{Theorem: properties of pmf / pdf}
    ...
    \begin{itemize}
      ...
      \item $\int_x f(x) = 1 \quad \text{(if pdf)}$.
    \end{itemize}
  \end{block}
  \begin{itemize}
...
\begin{frame}[allowframebreaks]{Variable transformations}
 ...
 \framebreak
  ...
  % TODO: Add example 2.1.6 from Casella and Berger. Also Example 2.1.7
